...
public class OBSHotkeysButtonsAdapter
    ...
    @NotNull
    @Override
    public OBSHotkeysButtonsAdapter.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
...
//        }
     ...
     *                          listener.
     */
    void setHotkeyClickListener(OBSHotkeysButtonsAdapter.OnHotkeyClickListener hotkeyClickListener) {
